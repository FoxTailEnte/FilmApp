...
class FilterAdapter(var item: List<String>, private var checkedItem: (CheckedItemModel) -> Unit): RecyclerView.Adapter<FilterHolder>() {
    ...
    override fun onBindViewHolder(holder: FilterHolder, position: Int) {
        holder.bind(list[position], newPosition,item,{
            newPosition = it
            notifyItem()
        }) {
